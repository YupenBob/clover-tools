...
# FIX 1: MD5
t = find('encrypt/md5.html')
if t:
    t['reverseFn'] = 'function(v){return "MD5 是不可逆哈希算法，无法解密。若已知明文可尝试彩虹表查询。";}'
    print("Fixed: MD5 reverseFn")

# FIX 2: SHA
t = find('encrypt/sha.html')
if t:
    t['reverseFn'] = 'function(v){return "SHA 是不可逆哈希算法，无法解密。若已知明文可尝试彩虹表查询。";}'
    print("Fixed: SHA reverseFn")

# FIX 3: LESS to CSS
t = find('code/less-to-css.html')
if t:
    t['formatFn'] = '''function(v, opts) {
  if (opts && opts.minify) {
  ...
  return result.join('\\n');
    ...
    print("Fixed: LESS to CSS formatFn")

# FIX 4: String sort
t = find('text/string-sort.html')
if t:
    t['formatFn'] = '''function(v, opts) {
  ...
  return lines.join('\\n');
    ...
    print("Fixed: string sort formatFn")

# FIX 5: Password generator
t = find('other/password.html')
if t:
    t['generateFn'] = '''function(inputs) {
  ...
  return result.join('\\n');
    ...
    print("Fixed: password generator generateFn")

# FIX 6: Social insurance calculator
t = find('life/insurance.html')
if t:
    t['fields'] = [
        {"id": "salary", "label": "税前工资(元)", "placeholder": "例如: 10000"},
        {"id": "city", "label": "城市", "placeholder": "例如: 北京"}
    ]
  ...
  return result;
    ...
    print("Fixed: social insurance calcFn")

# FIX 7: Salary after tax calculator
t = find('life/salary.html')
if t:
    t['fields'] = [
        {"id": "salary", "label": "税前工资(元)", "placeholder": "例如: 15000"},
        {"id": "insurance", "label": "五险一金(元)", "placeholder": "例如: 2000"}
    ]
    t['calcFn'] = '''function(inputs) {
  var salary = parseFloat(inputs.salary) || 0;
  ...
  return result;
    ...
    print("Fixed: salary calcFn")

# FIX 8: HTTP test (code/http-test.html)
t = find('code/http-test.html')
if t:
    t['config'] = {
    ...
    print("Fixed: HTTP test config")

# FIX 9: HTTP request tester (network/request-tester.html)
t = find('network/request-tester.html')
if t:
    t['config'] = {
        "method": {"type": "select", "label": "请求方法", "options": ["GET","POST","PUT","DELETE","PATCH"], "default": "GET"},
    ...
    print("Fixed: HTTP request tester config")

# FIX 10: WebSocket test
t = find('code/websocket-test.html')
if t:
    t['config'] = {
    ...
    print("Fixed: WebSocket test config")
...
if t:
  ...
  try {
    ...
    result += '}\\n';
    return result;
  } catch(e) { return 'JSON解析错误: ' + e.message; }
}'''
    print("Fixed: JSON to C#")
...
if t:
  ...
  function esc(v) {
    ...
    print("Fixed: JSON to SQL")

# FIX 15: JSON to TypeScript
