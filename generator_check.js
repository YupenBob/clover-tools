...
const PATH_TO_TYPE_FALLBACK = {
    'code/color-picker': 'color-picker-tool',
    'code/cron-parser': 'cron-parser',
    'code/css': 'formatter',
    'code/html': 'formatter',
    'code/javascript': 'formatter',
    'code/markdown': 'markdown-preview',
    'encrypt/base64': 'encode-decode',
    'encrypt/hex': 'hex-converter',
    'encrypt/md5': 'hash-tool',
    'encrypt/sha': 'hash-tool',
    'encrypt/unicode': 'unicode-tool',
    'encrypt/url': 'encode-decode',
    'json/formatter': 'formatter',
    'json/table': 'json-table',
    'json/xml': 'json-xml-converter',
    'json/yaml': 'json-yaml-converter',
    'life/grid-splitter': 'grid-splitter',
    'life/insurance': 'salary-calc',
    'life/price-compare': 'price-compare',
    'life/salary': 'salary-calc',
    'life/time-annotate': 'time-annotate',
    'life/zen-canvas': 'zen-canvas',
    'other/click-speed': 'click-speed',
    'other/color': 'color-picker',
    'other/hex-convert': 'hex-converter',
    'other/nanoid': 'generator',
    'other/password': 'generator',
    'other/reaction-test': 'reaction-test',
    'other/regex': 'regex-tester',
    'other/uuid': 'generator',
    'text/camel': 'text-camel',
    'text/case': 'text-multimode',
    'text/count': 'text-analysis',
    'text/diff': 'text-diff',
    'text/extract': 'text-extract',
    'text/garble-fix': 'text-garble-fix',
    'text/jianfan': 'jianfan-converter',
    'text/pinyin': 'text-pinyin',
    'time/age': 'age-calc',
    'time/countdown': 'countdown-tool',
    'time/interval': 'interval-calc',
    'time/lunar-birthday': 'lunar-birthday',
    'time/lunar-solar-converter': 'lunar-solar',
    'time/timestamp': 'timestamp-tool',
    'time/world': 'world-grid',
    'time/world-clock': 'world-clock'
};
...
const TOOL_TYPE_REGISTRY = {
  ...
  // type: "age-calc" — time/age
  'age-calc': {
    description: 'Auto-generated type for time/age',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
    script: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_SCRIPT_MAP[key] || '';
    }
  },

  // type: "click-speed" — other/click-speed
  'click-speed': {
    description: 'Auto-generated type for other/click-speed',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "color-picker" — other/color
  'color-picker': {
    description: 'Auto-generated type for other/color',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "color-picker-tool" — code/color-picker
  'color-picker-tool': {
    description: 'Auto-generated type for code/color-picker',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "countdown-tool" — time/countdown
  'countdown-tool': {
    description: 'Auto-generated type for time/countdown',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "cron-parser" — code/cron-parser
  'cron-parser': {
    description: 'Auto-generated type for code/cron-parser',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "grid-splitter" — life/grid-splitter
  'grid-splitter': {
    description: 'Auto-generated type for life/grid-splitter',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "hash-tool" — encrypt/sha, encrypt/md5
  'hash-tool': {
    description: 'Auto-generated type for encrypt/sha, encrypt/md5',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      switch(key) {
          case 'encrypt/sha': return `
      <div class="tool-card">
        <h3>输入</h3>
        <textarea id="input" placeholder="输入文本..."></textarea>
        <div style="margin-top:0.5rem;">
  ...
  // type: "hex-converter" — encrypt/hex, other/hex-convert
  'hex-converter': {
    description: 'Auto-generated type for encrypt/hex, other/hex-convert',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      switch(key) {
          case 'encrypt/hex': return `
      <div class="tool-card">
        <h3>输入</h3>
        <textarea id="input" placeholder="输入文本或十六进制（空格分隔）..."></textarea>
        <div class="btn-row">
  ...
  // type: "interval-calc" — time/interval
  'interval-calc': {
    description: 'Auto-generated type for time/interval',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "jianfan-converter" — text/jianfan
  'jianfan-converter': {
    description: 'Auto-generated type for text/jianfan',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "json-table" — json/table
  'json-table': {
    description: 'Auto-generated type for json/table',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "json-xml-converter" — json/xml
  'json-xml-converter': {
    description: 'Auto-generated type for json/xml',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "json-yaml-converter" — json/yaml
  'json-yaml-converter': {
    description: 'Auto-generated type for json/yaml',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "lunar-birthday" — time/lunar-birthday
  'lunar-birthday': {
    description: 'Auto-generated type for time/lunar-birthday',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "lunar-solar" — time/lunar-solar-converter
  'lunar-solar': {
    description: 'Auto-generated type for time/lunar-solar-converter',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "markdown-preview" — code/markdown
  'markdown-preview': {
    description: 'Auto-generated type for code/markdown',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "price-compare" — life/price-compare
  'price-compare': {
    description: 'Auto-generated type for life/price-compare',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "reaction-test" — other/reaction-test
  'reaction-test': {
    description: 'Auto-generated type for other/reaction-test',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "regex-tester" — other/regex
  'regex-tester': {
    description: 'Auto-generated type for other/regex',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "salary-calc" — life/insurance, life/salary
  'salary-calc': {
    description: 'Auto-generated type for life/insurance, life/salary',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      switch(key) {
  ...
  // type: "text-analysis" — text/count
  'text-analysis': {
    description: 'Auto-generated type for text/count',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "text-camel" — text/camel
  'text-camel': {
    description: 'Auto-generated type for text/camel',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "text-diff" — text/diff
  'text-diff': {
    description: 'Auto-generated type for text/diff',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "text-extract" — text/extract
  'text-extract': {
    description: 'Auto-generated type for text/extract',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "text-garble-fix" — text/garble-fix
  'text-garble-fix': {
    description: 'Auto-generated type for text/garble-fix',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "text-multimode" — text/case
  'text-multimode': {
    description: 'Auto-generated type for text/case',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "text-pinyin" — text/pinyin
  'text-pinyin': {
    description: 'Auto-generated type for text/pinyin',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "time-annotate" — life/time-annotate
  'time-annotate': {
    description: 'Auto-generated type for life/time-annotate',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "timestamp-tool" — time/timestamp
  'timestamp-tool': {
    description: 'Auto-generated type for time/timestamp',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "unicode-tool" — encrypt/unicode
  'unicode-tool': {
    description: 'Auto-generated type for encrypt/unicode',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "world-clock" — time/world-clock
  'world-clock': {
    description: 'Auto-generated type for time/world-clock',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "world-grid" — time/world
  'world-grid': {
    description: 'Auto-generated type for time/world',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
  ...
  // type: "zen-canvas" — life/zen-canvas
  'zen-canvas': {
    description: 'Auto-generated type for life/zen-canvas',
    html: function(tool) {
      var key = tool.path.replace(/\\.html$/, '');
      return TYPE_CONTENT_MAP[key] || '';
    },
...
function buildToolScript(tool) {
  ...
  // Get effective type: try explicit tool.type, then infer from path via PATH_TO_TYPE_FALLBACK
  const effectiveType = tool.type || PATH_TO_TYPE_FALLBACK[key];
  if (effectiveType && TOOL_TYPE_REGISTRY[effectiveType]) {
    const raw = TOOL_TYPE_REGISTRY[effectiveType].script(tool);
  ...
  // Fallback to hardcoded scripts map (from TYPE_SCRIPT_MAP)
  if (TYPE_SCRIPT_MAP[key]) {
    return TYPE_SCRIPT_MAP[key];
  }
  return '';
    'json/formatter': `
...
function buildToolContentHtml(tool) {
  ...
  // Fallback to hardcoded contents map (from TYPE_CONTENT_MAP)
  if (TYPE_CONTENT_MAP[key]) {
    return TYPE_CONTENT_MAP[key];
  }
  return '';
